<template>
  <div style="padding: 10px">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="400">
        <template #default="scope">
          ...
          <el-button size="mini" type="success" plain @click="showBooks(scope.row.bookList)">查看任务列表</el-button>
    ...
    <el-dialog title="用户拥有的任务列表" v-model="bookVis" width="30%">
      <el-table :data="bookList" stripe border>
        <el-table-column prop="id" label="ID"></el-table-column>
        <el-table-column prop="name" label="名称"></el-table-column>
        <el-table-column prop="price" label="等级"></el-table-column>
      </el-table>
    </el-dialog>
