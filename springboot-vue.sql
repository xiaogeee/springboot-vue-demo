...
CREATE TABLE `book`  (
  ...
  `price` decimal(10, 2) NULL DEFAULT NULL COMMENT '等级',
  `author` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '作者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '截止日期',
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, '器材', NULL);
INSERT INTO `category` VALUES (2, '水泵', 1);
INSERT INTO `category` VALUES (3, '水泵电路', 1);
INSERT INTO `category` VALUES (4, '管道', 1);
INSERT INTO `category` VALUES (5, '水泵房', 2);
INSERT INTO `category` VALUES (7, '智能电路', 3);
...
INSERT INTO `permission` VALUES (2, 'Book', '/book', '保养维修计划', 'el-icon-files');
INSERT INTO `permission` VALUES (3, 'Category', '/category', '分类管理', 'el-icon-menu');
INSERT INTO `permission` VALUES (4, 'Order', '/order', '任务回单', 'el-icon-s-order');
INSERT INTO `permission` VALUES (5, 'News', '/news', '设备档案', 'el-icon-news');
INSERT INTO `permission` VALUES (6, 'Map', '/map', '百度地图', 'el-icon-map-location');
INSERT INTO `permission` VALUES (7, 'Im', '/im', '信息交流', 'el-icon-chat-round');
...
INSERT INTO `permission` VALUES (12, 'Donate', '/donate', '疑难解答', 'el-icon-coffee');
...
CREATE TABLE `user`  (
  ...
  `account` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '账户等级',
  PRIMARY KEY (`id`) USING BTREE
